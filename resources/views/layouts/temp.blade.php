    ...
    <div class="flex h-screen bg-gray-50 dark:bg-gray-900" :class="{ 'overflow-hidden': isSideMenuOpen}">
      ...
      <aside class="z-20 hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0">
        <div class="py-4 text-gray-500 dark:text-gray-400">
          <a
            class="ml-6 text-lg font-bold text-green-600 dark:text-green-400"
            href="#"
          >
            GreenGang Store
          </a>
          ...
          <ul>
              ...
              <template x-if="isProductsMenuOpen">
                ...
                >
                  <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                  >
                    <a class="w-full" href="{{route('product.create')}}">
                      Registrar Nuevo
                    </a>
                  </li>
                  <li
            ...
            <li class="relative px-6 py-3">
              ...
              <template x-if="isProvidersMenuOpen">
                <ul
                  x-transition:enter="transition-all ease-in-out duration-300"
                  x-transition:enter-start="opacity-25 max-h-0"
                  x-transition:enter-end="opacity-100 max-h-xl"
                ...
                >
                  <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                  >
                    <a class="w-full" href="{{route('provider.create')}}">
                  ...
                  <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                  >
                    <a class="w-full" href="{{route('provider.index')}}">
          ...
          <div class="px-6 my-6">
            <a
            class="flex items-center justify-between w-full px-4 py-2 text-sm font-medium leading-5 text-gray-600 transition-colors duration-150 bg-green-100 border border-transparent rounded-lg active:bg-green-600 hover:bg-gray-100 focus:outline-none focus:shadow-outline-green"
            href="{{route('register')}}"
            >
              Registrarse
        ...
        <header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
          ...
          >
            ...
            <ul class="flex items-center flex-shrink-0 space-x-6">
                  ...
                  >
                    ...
                    <li class="flex">
                      <form method="POST" action="{{route('logout')}}" class="block w-full">
                        ...
                        <a
                          class="inline-flex items-center w-full px-2 py-1 text-sm font-semibold transition-colors duration-150 rounded-md hover:bg-gray-100 hover:text-gray-800 dark:hover:bg-gray-800 dark:hover:text-gray-200"
                          href="http://greengang.test/logout" onclick="event.preventDefault();
              ...
              <!-- Boton Inicia sesion-->
              <div>
                <a class="px-3 py-1 text-sm font-medium leading-5 text-green-700 transition-colors duration-150 bg-green-100 border border-transparent rounded-md active:bg-green-600 hover:bg-gray-100 focus:outline-none focus:shadow-outline-green"
                href="{{route('login')}}">
                  Ingresar
                </a>
              </div>
