...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  <head>
    ...
    <title>Ingresar - GreenGang</title>
    <link
          ...
          <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
            <div class="w-full">
              ...
              <form method="POST" action="{{ route('login') }}">
                ...
                <button
                    class="block w-full px-4 py-2 mt-8 text-sm font-medium leading-5 text-center text-white transition-colors duration-150 bg-green-500 border border-transparent rounded-lg active:bg-green-600 hover:bg-gray-100 hover:text-gray-700 focus:outline-none focus:shadow-outline-green"
                >
                    {{ __('Log in') }}
                </button>
              </form>
              ...
              <p class="mt-4">
                <a
                  class="text-sm font-medium text-green-700 dark:text-green-500 hover:underline"
