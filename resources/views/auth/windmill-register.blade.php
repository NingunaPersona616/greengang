...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  <head>
    ...
    <title>Crear Cuenta - GreenGang</title>
    <link
    ...
    <div class="flex items-center min-h-screen p-6 bg-gray-50 dark:bg-gray-900">
      ...
      >
            ...
            <div class="w-full">
              ...
              <form method="POST" action="{{route('register')}}">
                ...
                <label class="block mt-4 text-sm">
                  ...
                  placeholder="SeleneDelgado@example.com"
                  type="email"
                  name="email"
                  id="email"
                  value="{{old('email')}}"
                ...
                <div class="mt-4 text-sm">
                  ...
                  <div class="mt-2">
                    <label class="inline-flex items-center text-gray-600 dark:text-gray-400">
                      <input type="radio" class="text-green-600 form-radio focus:border-green-400 focus:outline-none focus:shadow-outline-green dark:focus:shadow-outline-gray" name="user_type" value="A">
                      <span class="ml-2">Admin</span>
                    </label>
                    <label class="inline-flex items-center ml-6 text-gray-600 dark:text-gray-400">
                      <input type="radio" class="text-green-600 form-radio focus:border-green-400 focus:outline-none focus:shadow-outline-green dark:focus:shadow-outline-gray" name="user_type" value="U">
                ...
                <label class="block mt-4 text-sm">
                  ...
                  <input
                  class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-green-400 focus:outline-none focus:shadow-outline-green dark:text-gray-300 dark:focus:shadow-outline-gray form-input
                  @error('password')  border-red-600 focus:border-red-400 focus:shadow-outline-red @enderror"
                  placeholder="***************"
                  type="password"
                  name="password"
                  id="password"
                ...
                <label class="block mt-4 text-sm">
                  ...
                  <input
                  class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-green-400 focus:outline-none focus:shadow-outline-green dark:text-gray-300 dark:focus:shadow-outline-gray form-input
                  @error('password_confirmation') border-red-600 focus:border-red-400 focus:shadow-outline-red @enderror"
                  placeholder="***************"
                  type="password"
                ...
                <div class="flex mt-6 text-sm">
                  <label class="flex items-center dark:text-gray-400">
                    <input
                    type="checkbox"
                    class="text-green-500 form-checkbox focus:border-purple-400 focus:outline-none focus:shadow-outline-green dark:focus:shadow-outline-gray"
                    />
                    <span class="ml-2">
                      I agree to the
                ...
                <button
                class="block w-full px-4 py-2 mt-4 text-sm font-medium leading-5 text-center text-white transition-colors duration-150 bg-green-500 border border-transparent rounded-lg active:bg-gray-600 hover:bg-gray-100 hover:text-gray-700 focus:outline-none focus:shadow-outline-green"
                >
                  {{__('Register')}}
                </button>
              </form>
        ...
        --}}
              ...
              <p class="mt-4">
                <a
                class="text-sm font-medium text-green-700 dark:text-green00 hover:underline"
                href="/login"
                >
